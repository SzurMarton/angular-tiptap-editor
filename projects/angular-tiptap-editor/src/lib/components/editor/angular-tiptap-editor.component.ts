...
import { AteSlashCommandsComponent, AteCustomSlashCommands } from "../slash-commands/ate-slash-commands.component";
...
import { filterSlashCommands, AteSlashCommandsConfig } from "../../config/ate-slash-commands.config";
