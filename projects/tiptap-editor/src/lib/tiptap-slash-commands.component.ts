...
export const DEFAULT_SLASH_COMMANDS: SlashCommandItem[] = [
  ...
  },
  {
    ...
    keywords: ["strike", "barré", "strikethrough", "s"],
  ...
  },
  {
    ...
    icon: "superscript",
    keywords: ["superscript", "exposant", "sup"],
  ...
  {
    title: "Centrer",
    description: "Centrer le texte",
    icon: "format_align_center",
    keywords: ["center", "centrer", "align", "alignement"],
  ...
  },
  {
    ...
    keywords: ["right", "droite", "align", "alignement"],
    command: (editor) => editor.chain().focus().setTextAlign("right").run(),
  },
  {
    title: "Justifier",
    description: "Justifier le texte",
    icon: "format_align_justify",
    keywords: ["justify", "justifier", "align", "alignement"],
